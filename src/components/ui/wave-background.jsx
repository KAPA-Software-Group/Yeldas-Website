 ...
 * Waves
 *
 * Flowing SVG wave line background driven by simplex noise + mouse interaction.
 * Converted from TypeScript to JSX — all logic preserved exactly.
 *
 * Props:
 *   className       — extra classes on the wrapper div
 *   strokeColor     — color of the wave lines  (default: gold at low opacity)
 *   backgroundColor — fill behind the lines    (default: site navy)
 *   pointerSize     — size of cursor dot in rem (default: 0.5)
 */
...
export function Waves({
  className = '',
  strokeColor = 'rgba(184, 147, 63, 0.28)',
  ...
  useEffect(() => {
    ...
    scrollObs.observe(containerRef.current)
