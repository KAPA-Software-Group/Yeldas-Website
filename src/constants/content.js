  ...
  ja: {
    ...
    SERVICES_PAGE: {
      hero: {
        ...
        subtext:
          "初回相談から最終解決まで、状況に合わせた包括的な移民法・法律サービスを提供します。",
        cta: { label: "ご相談を予約", href: "/contact" },
      },
      intro: {
        eyebrow: "幅広い分野をカバー",
        ...
        subtext:
          "カナダ移民法の幅広い分野に対応する、体系的な代理サービスを提供します。",
      },
      categoryMeta: {
        inadmissibility: {
          description:
            "複雑な入国不許可の問題に、経験ある法律サポートで対応します。健康上の理由、犯罪歴、退去手続きに直面する方を支援します。",
        },
        "permanent-resident": {
          description:
            "エクスプレス・エントリーから人道的配慮に基づく申請まで、プロフィールに合った永住権への道筋を整理します。",
        },
        "temporary-resident": {
          description:
            "カナダへの入国、就労、就学を安心して進められるよう、一時滞在者申請の幅広い分野を扱います。",
        },
        "business-immigration": {
          description:
            "創業者や経営者向けの専門的なビジネス移民プログラムを通じて、カナダでの事業構想を支援します。",
        },
        citizenship: {
          description:
            "カナダ市民権の取得や市民権に関する問題の解決に、経験ある法律代理で対応します。",
        },
      },
      labels: {
        practiceArea: "取扱分野",
      ...
      cta: {
        ariaLabel: "お問い合わせ",
        eyebrow: "始める準備",
        heading: "どこから始めるべきか迷っていますか",
        subtext:
          "移民の道のりは一人ひとり異なります。秘密厳守のご相談で、あなたに合った進め方を一緒に確認します。",
        label: "ご相談を予約",
        href: "/contact",
      },
    },
    ...
    ABOUT: {
      hero: {
        ...
        eyebrow: "私たちについて",
        heading: "信頼と結果を大切にする法律事務所",
        subtext:
          "Anwari Lawは、個人、ご家族、企業がカナダ移民法の複雑な手続きを進められるよう支援する、トロント拠点の移民法法律事務所です。",
      },
      story: {
        eyebrow: "私たちの歩み",
        heading: "地域に根ざし、目的を持って支援する",
        body: [
          "Anwari Lawは、質の高い移民法サービスを身近に提供するという理念のもとに設立され、カナダ移民法の幅広い分野で実績を築いてきました。",
          "移民は単なる法律手続きではなく、人生を大きく変える道のりです。私たちは法的知識と真摯な共感をもって、依頼者が理解され、支えられ、自信を持って進めるよう支援します。",
        ],
      },
      valuesSection: {
        eyebrow: "大切にしている価値",
      ...
      values: [
        {
          ...
          title: "依頼者中心",
          description:
            "案件は一つひとつ異なります。状況を丁寧に理解し、目標と事情に合わせた戦略を組み立てます。",
        },
        {
          number: "02",
          title: "透明性",
          description:
            "不意の驚きがないよう、各段階で選択肢を説明し、現実的な見通しを共有し、進捗を明確にお伝えします。",
        },
        {
          number: "03",
          title: "高い専門性",
          description:
            "法務実務の高い基準を保ち、政策変更を把握しながら、すべての申請に細心の注意を払います。",
        },
      ],
      teamSection: {
        eyebrow: "チーム",
        heading: "あなたの案件を支える人々",
        subtext: "カードを選択すると、チームについて詳しくご覧いただけます。",
      ...
      team: [
        {
          ...
          photo: "/team-yelda.png",
          bio:
            "Anwari Lawの創設者であり主任弁護士。Yeldaはカナダ移民法の幅広い分野に深い知見を持ち、丁寧な準備と真摯な姿勢で複雑な課題に取り組む依頼者を支援しています。",
        },
        {
          id: "prabh",
          name: "Prabh Simran Kaur",
          ...
          photo: "/team-prabh.webp",
          bio:
            "インドとオンタリオ州の両方で資格を有し、国際貿易法のLL.M.を取得。Anwari Lawでは難民申請、PRRA、司法審査、不服申立てを中心に、法的洞察と依頼者中心の姿勢を組み合わせて支援しています。",
        },
        {
          id: "vai",
          name: "Vaishalei Manoharan",
          ...
          photo: "/team-vai.webp",
          bio:
            "University of Sussex卒業後、民事訴訟で2年以上の経験を積みました。難民法・移民法に情熱を持ち、弁護士登録後に優れた代理人となることを目指しています。",
        },
      ],
      approach: {
        eyebrow: "私たちのアプローチ",
        heading: "あなたに合わせた戦略",
        body:
          "万能の解決策はないと考えています。初回相談から状況を丁寧に評価し、明確で効果的な戦略を構築します。最初の申請から最終解決まで、チームが継続して支援します。",
        points: [
          "状況全体を把握するための詳細な初回ヒアリング",
          "移民上の目標に沿った個別戦略",
          "各段階で直接相談できる専任法律チーム",
          "書類準備と提出管理の徹底",
          "主体的な進捗共有と透明なコミュニケーション",
          "問題が生じた場合の不服申立て・代理対応",
        ],
      },
      cta: {
